...
const icons = { Dashboard: LayoutDashboard, Interns: Users, Projects: FolderKanban, Board: FolderKanban, Tasks: ClipboardList, Calendar: CalendarDays, Documents: FileText, Profile: User };
